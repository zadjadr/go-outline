...
func newDocumentsUpdateClient(sl *sling.Sling, params documentsUpdateParams) *DocumentsUpdateClient {
	copy := sl.New()
...
func (cl *DocumentsClient) Update(id DocumentID) *DocumentsUpdateClient {
	return newDocumentsUpdateClient(cl.sl, documentsUpdateParams{Id: id})
}
